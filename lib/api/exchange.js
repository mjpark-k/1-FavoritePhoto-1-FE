...
export async function acceptExchange({ exchangedId }) {
  try {
    const res = await renderApi.post(`/exchange/${exchangedId}/accept`);
    return res;
  } catch (error) {
...
export async function refuseExchange({ exchangedId }) {
  try {
    const res = await renderApi.post(`/exchange/${exchangedId}/refuse`);
    return res;
  } catch (error) {
...
export async function deleteExchange({ exchangedId }) {
  try {
    const res = await renderApi.post(`/exchange/${exchangedId}`);
    return res;
  } catch (error) {
